...
P "Cronograma de entregas macro (secao 10 do formulario): e editado no Planejamento (Passo 4) - aqui o TAP mostra, so leitura, o mesmo cronograma ao vivo: numero do marco (Nº), responsavel, Inicio/Termino previstos, Conclusao real, custo e dependencia. Para alterar um marco, use o Planejamento. Alem de Inicio e Termino previstos, cada marco tem um campo `Conclusao real`, preenchido quando o marco de fato termina - e o que permite ao sistema distinguir um marco `atrasado agora` de um marco que `terminou atrasado`: um marco com Conclusao real preenchida nunca conta como atrasado no calculo de Saude do projeto (secao 6.4.1) nem no indicador Marcos no prazo (secao 6.7), mesmo que o Termino previsto ja tenha passado."
P "Dependencia entre marcos: cada marco tambem tem um campo opcional `Depende do nº`, onde se digita o numero de outro marco do mesmo cronograma (por exemplo, o marco 2 pode depender do marco 1). Se o marco indicado ainda nao tiver Conclusao real e o Termino previsto ja tiver passado, o marco dependente ganha um aviso `bloqueado` - visivel no proprio Planejamento (edicao, detalhes e impressao/exportacao), no espelho do TAP e nos Marcos do Relatorio de Situacao. E uma verificacao simples, de um nivel so e por numero - nao calcula um caminho critico completo nem cadeias de varios marcos."
...
P "Dependencia entre marcos: cada marco tambem tem um campo opcional `Depende do nº`, onde se digita o numero de outro marco do mesmo cronograma. Se o marco indicado ainda nao tiver Conclusao real e o Termino previsto ja tiver passado, o marco dependente ganha um aviso `bloqueado` - visivel no proprio Planejamento, no espelho do TAP e nos Marcos do Relatorio de Situacao."
