...
Bul "O e-mail inclui um link direto para a Ficha do Projeto (secao 6.4.1) daquele projeto, para abrir a saude do projeto e o cronograma completo sem precisar navegar manualmente."
