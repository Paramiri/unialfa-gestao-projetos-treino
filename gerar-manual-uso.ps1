...
P "Versao 2.30 - 20 de agosto de 2026 (substitui a versao 2.29 de 20/08/2026)" 11 $false $false $colMuted "left" 2
...
H2 "2.12 Assistente de preenchimento por IA (Canvas, TAP, Planejamento, EAP, SMP, TEP e RLA)"
...
P "Mesma logica de custo e permissao da importacao de transcricao (secao 2.10): interruptor geral do Admin, desligado por padrao, e lista de papeis liberados em Administracao > Configuracoes (secao 6.3) - um unico interruptor cobre os 7 formularios, e PMO/Admin sempre tem acesso quando esta ligado. Alem disso, so quem faz parte da equipe do projeto selecionado (secao 2.5) pode usar o botao."
