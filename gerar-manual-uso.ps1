...
P "Esta e a versao 2.75 do manual. Em relacao a versao 2.74 (15/09/2026), foi adicionada a nova secao 2.15 - Quem pode editar ou excluir um registro ja criado: nos 9 formularios de registro individual, editar passa a exigir ser quem criou o registro, o Gerente de Projetos ou o Admin, e excluir passa a exigir o Gerente de Projetos ou o Admin. Os botoes correspondentes ficam ocultos para quem nao tem permissao. O documento Regras de Acesso e Permissoes tambem foi atualizado (secao 5.4)."
