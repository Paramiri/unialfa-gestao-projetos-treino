...
Bul "Vale para os 12 formularios de registro. Nos tres relatorios que reunem todos os projetos numa unica tela - Plano de Comunicacao (Passo 10), Relatorio de Situacao (secao 4.1) e Relatorio de Entregas (secao 4.2) - o aviso aparece se qualquer outra pessoa salvar esse mesmo relatorio entre o momento em que a tela de edicao foi aberta e o `Salvar`."
