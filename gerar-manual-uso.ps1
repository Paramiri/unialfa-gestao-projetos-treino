...
P "Por ultimo, um bloco `Metas dos indicadores estrategicos` define a meta em % de cada um dos 3 indicadores do Relatorio de Resultados (secao 6.7) - Marcos no prazo, Projetos dentro do orcamento e Entraves resolvidos. Enquanto uma meta ficar vazia, o cartao correspondente mostra `Meta nao definida` em vez de um selo de status."
Img "53_admin_metas_resultados.png" "Bloco Metas dos indicadores estrategicos, com os 3 campos preenchidos." 5.8
...
Img "51_relatorio_resultados_kpis.png" "Os tres indicadores estrategicos do Relatorio de Resultados, com meta, barra de progresso, selo de status e tendencia." 5.8
