...
P "Tres paginas independentes, listadas no menu lateral em `Gestao`: a Administracao (gerencia usuarios, equipes e configuracoes, sempre restrita a Admin - secao 2.3), o Painel Executivo (visao consolidada e agregada de todo o sistema, com acesso configuravel por papel - secao 6.3) e o Relatorio de Resultados (indicadores estrategicos e plano de acao para a reuniao mensal de resultados, tambem com acesso configuravel por papel - secoes 6.3 e 6.7)."
H2 "6.1 Usuarios"
...
P "Logo abaixo, quatro grupos de caixas de selecao controlam quem pode ver o Painel Executivo, o Relatorio de Resultados, o Relatorio de Situacao de Projetos e o Relatorio de Entregas e Beneficios: o Admin marca um ou mais papeis por pagina, e quem tiver um papel fora da lista marcada ve `Acesso restrito` ao tentar abrir aquela pagina. Por padrao, o Painel Executivo e o Relatorio de Resultados comecam marcados so para Admin (mesmo comportamento de antes), e os dois relatorios finais comecam com todos os papeis marcados (acesso livre, tambem o comportamento de antes) - a restricao so entra em vigor se o Admin desmarcar algum papel."
P "Um quinto grupo, `Quem pode editar o Plano de Comunicacao de Projeto`, controla so a aba `Editar dados` desse formulario (Passo 10) - diferente dos quatro grupos acima, que controlam a pagina inteira. Comeca marcado apenas para PMO/Admin; qualquer papel fora da lista continua vendo e imprimindo o Painel normalmente, so nao consegue editar."
Nota "O papel Admin sempre tem acesso a essas cinco configuracoes, mesmo que fique desmarcado por engano - isso evita que o proprio Admin perca o acesso e fique sem como reverter a configuracao."
